 ...
 */
final class Version20250417211650 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__musica_cancion AS SELECT id, genero_id, titulo, artista, album, descripcion, imagen, url, es_publico, anio, duracion, creado_en, actualizado_en FROM musica_cancion');
        ...
        , FOREIGN KEY (genero_id) REFERENCES musica_genero (id) ON UPDATE NO ACTION ON DELETE NO ACTION NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO musica_cancion (id, genero_id, titulo, artista, album, descripcion, imagen, url, es_publico, anio, duracion, creado_en, actualizado_en) SELECT id, genero_id, titulo, artista, album, descripcion, imagen, url, es_publico, anio, duracion, creado_en, actualizado_en FROM __temp__musica_cancion');
        $this->addSql('DROP TABLE __temp__musica_cancion');
        $this->addSql('CREATE INDEX IDX_B1CAA9BBBCE7B795 ON musica_cancion (genero_id)');
        $this->addSql('CREATE TEMPORARY TABLE __temp__musica_genero AS SELECT id, nombre, descripcion, icono, creado_en FROM musica_genero');
        ...
        $this->addSql('INSERT INTO musica_genero (id, nombre, descripcion, icono, creado_en) SELECT id, nombre, descripcion, icono, creado_en FROM __temp__musica_genero');
        $this->addSql('DROP TABLE __temp__musica_genero');
        $this->addSql('CREATE TEMPORARY TABLE __temp__musica_playlist AS SELECT id, nombre, descripcion, imagen, creador_id, creador_nombre, es_publica, creado_en, actualizado_en FROM musica_playlist');
        ...
        $this->addSql('INSERT INTO musica_playlist (id, nombre, descripcion, imagen, creador_id, creador_nombre, es_publica, creado_en, actualizado_en) SELECT id, nombre, descripcion, imagen, creador_id, creador_nombre, es_publica, creado_en, actualizado_en FROM __temp__musica_playlist');
        $this->addSql('DROP TABLE __temp__musica_playlist');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__musica_cancion AS SELECT id, genero_id, titulo, artista, album, descripcion, imagen, url, es_publico, anio, duracion, creado_en, actualizado_en FROM musica_cancion');
        $this->addSql('DROP TABLE musica_cancion');
        $this->addSql('CREATE TABLE musica_cancion (id INTEGER PRIMARY KEY AUTOINCREMENT DEFAULT NULL, genero_id INTEGER DEFAULT NULL, titulo VARCHAR(255) NOT NULL, artista VARCHAR(255) DEFAULT NULL, album VARCHAR(255) DEFAULT NULL, descripcion CLOB DEFAULT NULL, imagen VARCHAR(255) DEFAULT NULL, url VARCHAR(255) DEFAULT NULL, es_publico BOOLEAN DEFAULT 1 NOT NULL, anio INTEGER DEFAULT NULL, duracion INTEGER DEFAULT NULL, creado_en DATETIME NOT NULL, actualizado_en DATETIME DEFAULT NULL, CONSTRAINT FK_B1CAA9BBBCE7B795 FOREIGN KEY (genero_id) REFERENCES musica_genero (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO musica_cancion (id, genero_id, titulo, artista, album, descripcion, imagen, url, es_publico, anio, duracion, creado_en, actualizado_en) SELECT id, genero_id, titulo, artista, album, descripcion, imagen, url, es_publico, anio, duracion, creado_en, actualizado_en FROM __temp__musica_cancion');
        $this->addSql('DROP TABLE __temp__musica_cancion');
        $this->addSql('CREATE INDEX IDX_B1CAA9BBBCE7B795 ON musica_cancion (genero_id)');
        $this->addSql('CREATE TEMPORARY TABLE __temp__musica_genero AS SELECT id, nombre, descripcion, icono, creado_en FROM musica_genero');
        $this->addSql('DROP TABLE musica_genero');
        $this->addSql('CREATE TABLE musica_genero (id INTEGER PRIMARY KEY AUTOINCREMENT DEFAULT NULL, nombre VARCHAR(255) NOT NULL, descripcion VARCHAR(255) DEFAULT NULL, icono VARCHAR(255) DEFAULT NULL, creado_en DATETIME NOT NULL)');
        $this->addSql('INSERT INTO musica_genero (id, nombre, descripcion, icono, creado_en) SELECT id, nombre, descripcion, icono, creado_en FROM __temp__musica_genero');
        $this->addSql('DROP TABLE __temp__musica_genero');
        $this->addSql('CREATE TEMPORARY TABLE __temp__musica_playlist AS SELECT id, nombre, descripcion, imagen, creador_id, creador_nombre, es_publica, creado_en, actualizado_en FROM musica_playlist');
        $this->addSql('DROP TABLE musica_playlist');
        $this->addSql('CREATE TABLE musica_playlist (id INTEGER PRIMARY KEY AUTOINCREMENT DEFAULT NULL, nombre VARCHAR(255) NOT NULL, descripcion CLOB DEFAULT NULL, imagen VARCHAR(255) DEFAULT NULL, creador_id VARCHAR(255) NOT NULL, creador_nombre VARCHAR(255) DEFAULT NULL, es_publica BOOLEAN DEFAULT 0 NOT NULL, creado_en DATETIME NOT NULL, actualizado_en DATETIME DEFAULT NULL)');
        $this->addSql('INSERT INTO musica_playlist (id, nombre, descripcion, imagen, creador_id, creador_nombre, es_publica, creado_en, actualizado_en) SELECT id, nombre, descripcion, imagen, creador_id, creador_nombre, es_publica, creado_en, actualizado_en FROM __temp__musica_playlist');
        $this->addSql('DROP TABLE __temp__musica_playlist');
    }
}
