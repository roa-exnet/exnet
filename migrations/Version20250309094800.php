 ...
 */
final class Version20250309094800 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__modulo AS SELECT id, nombre, descripcion, install_date, uninstall_date, icon, ruta, estado FROM modulo');
        ...
        $this->addSql('INSERT INTO modulo (id, nombre, descripcion, install_date, uninstall_date, icon, ruta, estado) SELECT id, nombre, descripcion, install_date, uninstall_date, icon, ruta, estado FROM __temp__modulo');
